...
function Carousel() {
  ...
  const items = [
    ...
    },
    {
      ...
      srcLink:
        "https://res.cloudinary.com/dvnhn35l4/image/upload/v1697951745/Animala/350091469_771875407930011_1637485298770860654_n_mwasyp.jpg",
      audioSrc:
        "https://res.cloudinary.com/dvnhn35l4/video/upload/v1698689471/Nicolas_Nieves_Agust%C3%ADn_Bragoni_Simon_Di_Marzio_-_Rivera_Paradise_South_America_Avenue_imwpnj.mp3",
    },
    {
      text: "Nicolas Nieves, Agustín Bragoni, Simon Di Marzio",
      title: "DirtyPool ",
