      ...
      <div className="hero-section">
        <div className="container">
          <div data-speed=".75" className="main-header">
            ...
            <h6 className="subtitle">Agustin Bragoni</h6>
          </div>
          <video
            ref={videoRef}
            data-speed=".6"
          ...
          >
            <source
              src="https://res.cloudinary.com/dvnhn35l4/video/upload/v1697392290/Agustin_Bragoni_-_Living_Stereo_Session_1_1080p_ug5zqm.mp4"
              type="video/mp4"
            />
